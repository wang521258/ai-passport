...
# 0x300000(3MB) 是上游保守值。硬件上 factory 最大能到 0x346000：
#   0x10000 + 0x346000 = 0x356000 = CARDID_OFFSET，再大就会压到设备卡号区。
# 宠物固件（42 只 GIF 精灵 + 1151 词 + 88KB 中文字库）需要这个上限才装得下。
APP_MAX_SIZE = 0x346000
